  ...
  return (
    <div className="term">
      ...
      <footer className="term__foot">
        ...
        <a href="https://linkedin.com/in/amandajuvera" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 16 16" aria-hidden="true">
        ...
        <a href="https://github.com/amandajuvera" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 16 16" aria-hidden="true">
